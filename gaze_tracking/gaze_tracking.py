...
class GazeTracking(object):
    ...
    def __init__(self):
        ...
        model_path = os.path.abspath(os.path.join(cwd, "dlib/shape_predictor_68_face_landmarks.dat"))
    ...
    def is_right(self):
        ...
        if self.pupils_located:
            return self.horizontal_ratio() <= 0.615
    ...
    def is_oy_center(self):
        # Returns true if the user is looking to the center (for OY axis)
        if self.pupils_located:
    ...
    def is_down(self):
        ...
        if self.pupils_located:
            return self.vertical_ratio() >= 1.15
            
    def is_ox_center(self):
        # Returns true if the user is looking to the center (for OX axis)
        if self.pupils_located:
    ...
    def eye_ratio(self):
        # Returns true if the user closes his eyes
        if self.pupils_located:
            eye_ratio = (self.eye_left.blinking + self.eye_right.blinking) / 2
            return eye_ratio
